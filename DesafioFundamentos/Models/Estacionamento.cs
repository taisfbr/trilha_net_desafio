namespace DesafioFundamentos.Models
{
    public class Estacionamento
    {
        ...
        public void AdicionarVeiculo()
        {
            ...
            string placaDigitada = string.Empty;
            do
            {
                placaDigitada = Console.ReadLine();
                if(placaDigitada.Length < 6 )
                {
                    Console.WriteLine("Placa informada não é válida.");
                }
            } while(placaDigitada.Length < 6);
        ...
        public void RemoverVeiculo()
        {
            ...
            if (veiculos.Any(x => x.Equals(placa, StringComparison.OrdinalIgnoreCase)))
            {
				...
				{
					Console.WriteLine("Por favor, digite um valor válido de horas:");
				}
